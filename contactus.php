...
if(!isset($_SESSION['id'])) {
  $_SESSION['preLocation'] = 'contactus.php';
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/51.jpg" alt="Los Angeles" width="1100" height="500">
      <div class="carousel-caption">
        <h3>Get in touch</h3>
        <p>While we're good with smoke signals, there are simpler ways for us t
    o get in touch and answer your questions.</p>
      </div>   
    </div>
  </div>
</div>
